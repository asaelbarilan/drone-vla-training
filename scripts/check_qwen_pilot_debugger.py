...
with sync_playwright() as p:
    ...
    for folder in sorted(args.runs.glob("qwen_local_overfit_s*")):
        ...
        for at in (0, len(records) // 2, len(records) - 1):
...
print(
    f"PASS {len(checks)} exact response/image/prompt/source-time checks; three outcomes; playback"
)
