# ruff: noqa: E402
"""D145 released openfly_vla on the frozen 72-case D144 panel; no training."""
...
assert args.eval_data is not None and args.prompt_style == "model_card", (
    "Use raw route instruction as in released eval.py"
)
